...
const JulyT22 = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/tables/getAllDataJulyt22")
      .then((response) => {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`http://localhost:4000/tables/deleteJulyt22/${id}`)
      .then((response) => {
        console.log(response);
        setAddData(response.data);
      })
  ...
  const handleUpload = () => {
    ...
    console.log(body);
    axios
      .post("http://localhost:4000/tables/addNewJulyt22", body)
      .then((response) => {
        console.log(response);
