...
const MarchT22 = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/tables/getAllDataMarcht22")
      .then((response) => {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`http://localhost:4000/tables/deleteMarcht22/${id}`)
      .then((response) => {
        console.log(response);
        setAddData(response.data);
      })
  ...
  const handleUpload = () => {
    ...
    console.log(body);
    axios
      .post("http://localhost:4000/tables/addNewMarcht22", body)
      .then((response) => {
        console.log(response);
