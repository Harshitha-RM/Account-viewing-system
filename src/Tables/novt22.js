...
const NovT22 = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/tables/getAllDataNovt22")
      .then((response) => {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`http://localhost:4000/tables/deleteNovt22/${id}`)
      .then((response) => {
        console.log(response);
        setAddData(response.data);
      })
  ...
  const handleUpload = () => {
    ...
    console.log(body);
    axios
      .post("http://localhost:4000/tables/addNewNovt22", body)
      .then((response) => {
        console.log(response);
